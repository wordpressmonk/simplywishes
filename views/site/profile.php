...
<script src="<?= Yii::$app->request->baseUrl?>/src/imagesloaded.js" type="text/javascript"></script>	
	...
	<ul class="nav nav-tabs smp-mg-bottom" role="tablist">
	  <li role="presentation" class="active"><a href="#activewish" role="tab" data-toggle="tab">My Active Wishes</a></li>
	  <li role="presentation"><a href="#fullfilledwish" role="tab" data-toggle="tab">My Fullfilled Wishes</a></li>
	</ul>
